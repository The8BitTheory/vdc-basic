...
140 DC=4:DIM DM(DC-1,4):DIM PO(DC-1,1)

145 FOR FI=0 TO DC-1:READ YC,XC:PO(FI)=YC*80+XC/2:NEXT

150 FOR FI=1TO DC:FF$=MID$(STR$(FI-1),2):FI$=FF$+".VMS2"
...
280 BSAVE ("@"+FF$+".VMS",B0,P(BE)TOP(BE+OS+D)
...
1000 DATA 0,0 ,0,118, 4,0, 4,18, 4,118, 4,18, 4,98, 17,0, 17,18, 17,38, 17,98, 17,118, 17,38, 17,88, 22,18, 22,38, 22,48, 22,88, 22,98
