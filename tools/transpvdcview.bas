...
326 PRINT "ALPHA-COLOR:"PEEK(DB+4)
327 PRINT "NR COMMANDS:"PEEK(DB+5)
330 RTV DB+ML,24000,IL
335 SP=DB+4:TA=0:ATTR 0:AP(0)=0:AP(1)=8000:AX=0
...
400  GETKEY I$
405  PT=TA
410  IF I$="I" THEN TA=TA-80:IF TA<0 THEN TA=PT
420  IF I$="K" THEN TA=TA+80:IF TA>5600 THEN TA=PT
430  IF I$="J" THEN TA=TA-1:IF TA<0 THEN TA=PT
440  IF I$="L" THEN TA=TA+1:IF TA>5600 THEN TA=PT
